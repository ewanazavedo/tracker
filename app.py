...
LOGO_PATH = APP_DIR / "C:/Users/Ewan Azavedo/Downloads/attendance_tracker/add.jpg"
    ...
    st.markdown(f"""
        <div class="sidebar-brand">
            <div class="brand-icon">
                <img src="data:image/png;base64,{base64.b64encode(LOGO_PATH.read_bytes()).decode()}" alt="Logo">
            </div>
            <div>
